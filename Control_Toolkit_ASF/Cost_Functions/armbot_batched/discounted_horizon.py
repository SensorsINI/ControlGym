...
angle1_weight = float(config["armbot_batched"]["discounted_horizon"]["angle1_weight"])
angle2_weight = float(config["armbot_batched"]["discounted_horizon"]["angle2_weight"])
angleD1_weight = float(config["armbot_batched"]["discounted_horizon"]["angleD1_weight"])
angleD2_weight = float(config["armbot_batched"]["discounted_horizon"]["angleD2_weight"])
...
class discounted_horizon(cost_function_base):
    MAX_COST = angle1_weight + angle2_weight + angleD1_weight * (armbot_batched.MAX_VEL_1 ** 2) + angleD2_weight * (armbot_batched.MAX_VEL_2 ** 2)
